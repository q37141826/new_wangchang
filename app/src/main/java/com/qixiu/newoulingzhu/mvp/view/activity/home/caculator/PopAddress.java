...
public class PopAddress {
        ...
        if (popupWindow != null) {
            ...
            OKHttpRequestModel okHttpRequestModel = new OKHttpRequestModel(new OkHttpUIUpdataAdapterListener() {
                ...
                public void onSuccess(Object data, int i) {
                    if (data instanceof ProvicesBean) {
                        ProvicesBean beans = (ProvicesBean) data;
            ...
            okHttpRequestModel.okHttpGet(ConstantUrl.getCityUrl, map, new ProvicesBean());
        }
    }

    public PopAddress( Context context,OnItemClickListenner listenner) {
        this.listenner = listenner;
        this.context = context;
    }

    private void setPopupWindow(Context context, List<ProvicesBean.OBean> datas, OnItemClickListenner listenner) {
        ...
        addressAdapter.setOnItemClickListener(new OnRecyclerItemListener() {
            ...
            public void onItemClick(View v, RecyclerView.Adapter adapter, Object data) {
                if (listenner != null) {
                    listenner.onItemClick((ProvicesBean.OBean) data);
                }
                popupWindow.dismiss();
            }
        });
    ...
    public interface OnItemClickListenner {
        void onItemClick(ProvicesBean.OBean data);
    }


    public class AddressAdapter extends RecyclerBaseAdapter<ProvicesBean.OBean,AddressAdapter.AddressHolder> {
        @Override
        ...
        public class AddressHolder extends RecyclerBaseHolder<ProvicesBean.OBean>{
            ...
            public void bindHolder(int position) {
                textViewAddressItemPop.setText(mData.getProvince());
            }
        }
    }

    public class ProvicesBean extends BaseBean<List<ProvicesBean.OBean>> {
        public class OBean {
            private String id;
