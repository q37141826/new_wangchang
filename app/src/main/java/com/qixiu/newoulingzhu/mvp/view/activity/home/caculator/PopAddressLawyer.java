...
public class PopAddressLawyer {
    ...
    public void requstPop() {
        if (popupWindow != null) {
            ...
            okHttpRequestModel.okHttpGet(ConstantUrl.getLawyarAddressUrl, map, new ProvicesBean());
        }
    }

    public PopAddressLawyer(Context context, OnItemClickListenner listenner) {
