...
public class PopCaseTypeLawyer {
    ...
    public void requstPop() {
        if (popupWindow != null) {
            ...
            okHttpRequestModel.okHttpGet(ConstantUrl.getLawyarCaseTypeUrl, map, new LawyerCaseBean());
        }
    }

    public PopCaseTypeLawyer(Context context, OnItemClickListenner listenner) {
    ...
    public class LawyerCaseBean extends BaseBean<List<LawyerCaseBean.OBean>>{
        ...
        public  class OBean {
            ...
            public void setIs_fee(boolean is_fee) {
                this.is_fee = is_fee;
            }
        }
    }
