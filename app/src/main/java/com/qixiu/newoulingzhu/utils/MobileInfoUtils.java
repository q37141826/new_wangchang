...
import com.qixiu.newoulingzhu.receiver.MyBootReceiver;
...
public class MobileInfoUtils{
    ...
    public static boolean isOpenAuto(Context context){
        ComponentName localComponentName = new ComponentName(context, MyBootReceiver.class);
        int i = context.getPackageManager().getComponentEnabledSetting(localComponentName);
        Log.e("state","是否开始自启动"+i);
        if(i==1){
            return true;
        }else {
            return false;
